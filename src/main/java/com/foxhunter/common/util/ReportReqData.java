...
public class ReportReqData {
    ...
    public static String PAY_INTEERFACE = "https://api.mch.weixin.qq.com/pay/unifiedorder";
     ...
     */
    public ReportReqData(String deviceInfo, int executeTimeCost, String returnCode, String returnMsg, String resultCode, String errCode, String errCodeDes, String outTradeNo) {
        //微信分配的公众号ID（开通公众号之后可以获取到）
        setAppid(appID);
        ...
        setInterface_url(PAY_INTEERFACE);
